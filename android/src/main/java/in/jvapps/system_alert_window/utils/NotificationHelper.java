...
public class NotificationHelper {
    ...
    public void showNotification(Icon icon, String notificationTitle, String notificationBody, HashMap params) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(mContext, REQUEST_BUBBLE, bubbleIntent, getPendingIntentFlag());
        ...
        Notification.Builder builder = new Notification.Builder(mContext, CHANNEL_ID)
                ...
                .addPerson(person)
                .setShowWhen(true)
                .setContentIntent(PendingIntent.getActivity(mContext, REQUEST_CONTENT, bubbleIntent, getPendingIntentFlag()))
    ...
    int getPendingIntentFlag() {
        return (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) ? PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT : PendingIntent.FLAG_UPDATE_CURRENT;
    }
